...
def _libsvm_generate(num_features, list_size, doc_list, should_shuffle=True):
...
def libsvm_generator(path, num_features, list_size, seed=None, should_shuffle=False):
  ...
  def inner_generator():
    ...
    with tf.io.gfile.GFile(path, "r") as f:
      ...
      for line in f:
        ...
        yield _libsvm_generate(num_features, list_size, doc_list, should_shuffle)
